...
We will first request a FRED API key which can be found following the link ![FRED API Key Link](https://fredaccount.stlouisfed.org/apikeys) For security purposes, I will not disclose the key which I was given.
